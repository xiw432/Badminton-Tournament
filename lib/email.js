 ...
 * @param {object} player  - player data (playerId, name, email, category, gender, totalFee)
 * @param {Buffer|Uint8Array} pdfBytes - raw PDF bytes
 */
...
<table width="100%" cellpadding="0" cellspacing="0" style="padding:20px 0;background:#f8f9fa;">
    ...
    <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.1);">
      ...
      <tr><td style="padding:0 30px 28px;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#F8FAFC;border-radius:8px;padding:18px;">
          <tr><td style="padding:6px 0;font-size:14px;"><strong style="color:#0B1D3A;">Player ID:</strong>
            <span style="color:#F5B800;font-size:17px;font-weight:bold;margin-left:8px;">${player.playerId}</span></td></tr>
          <tr><td style="padding:6px 0;font-size:14px;color:#475569;"><strong style="color:#0B1D3A;">Category:</strong> ${player.category}</td></tr>
          <tr><td style="padding:6px 0;font-size:14px;color:#475569;"><strong style="color:#0B1D3A;">Gender:</strong> ${player.gender}</td></tr>
          <tr><td style="padding:6px 0;font-size:14px;color:#475569;"><strong style="color:#0B1D3A;">Total Fee:</strong> ₹${player.totalFee}</td></tr>
        </table>
      </td></tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#FEF3C7;border:2px dashed #F59E0B;border-radius:12px;padding:20px;">
          <tr><td style="text-align:center;">
            ...
            <p style="margin:0;color:#78350F;font-size:13px;line-height:1.6;">
              Pay <strong>₹${player.totalFee}</strong> in CASH to your Coach before the tournament.<br>
      ...
      <tr><td style="background:#F8FAFC;padding:18px 30px;text-align:center;border-top:1px solid #E2E8F0;">
        <p style="margin:0;color:#94A3B8;font-size:11px;">SMAASH Badminton Tournament 2026 · © 2026 All rights reserved</p>
      </td></tr>
  ...
  return resend.emails.send({
    from: process.env.FROM_EMAIL || 'SMAASH Tournament <noreply@smashbadminton.com>',
    to: player.email,
